...
@pytest.mark.parametrize(
    ...
    [
        ("2024-10-01", starlette.status.HTTP_200_OK),
        ("2024-12-41", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
        ("2024/10/01", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
        ("2024-1001", starlette.status.HTTP_422_UNPROCESSABLE_ENTITY),
    ],
)
async def test_create_due_date(async_client, input_param, exception):
    response = await async_client.post(
